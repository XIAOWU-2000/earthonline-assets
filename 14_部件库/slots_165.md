...
| SOC-05 | 社交 | 学习 | 文曲·礼 | `concept_wenqu_li.png` |
| SOC-06 | 社交 | 对抗 | 急躁·抢 | `concept_jizao_qiang.png` |
| SOC-07 | 社交 | 修复 | 太乙·圆 | `concept_taiyi_yuan.png` |
| SOC-08 | 社交 | 告别 | 地劫·散 | `concept_dijie_san.png` |
| SOC-09 | 社交 | 忍耐 | 陀罗·沉 | `concept_tuoluo_chen.png` |
| SOC-10 | 社交 | 求助 | 天乙·赠 | `concept_tianyi_zeng.png` |
| SOC-11 | 社交 | 模糊 | 天空·涣 | `concept_tiankong_huan.png` |
