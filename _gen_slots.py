...
MAPPED = {
    ...
    "LIV-01": ("巨门·叩", "concept_jumen_kou.png"),
    "LIV-04": ("文昌·候", "concept_wenchang_hou.png"),
    "LIV-05": ("文曲·契", "concept_wenqu_qi.png"),
    "LIV-06": ("擎羊·邻", "concept_qingyang_lin.png"),
    ...
    "SEF-03": ("武曲·怠", "concept_wuqu_dai.png"),
    "SEF-04": ("天同·守", "concept_tiantong_shou.png"),
    "SEF-05": ("文曲·省", "concept_wenqu_xing.png"),
    "SEF-06": ("七杀·讼", "concept_qisha_song.png"),
    "SEF-07": ("太乙·愈", "concept_taiyi_yu.png"),
    "SEF-08": ("地劫·蜕", "concept_dijie_tui.png"),
    "SEF-10": ("天乙·呼", "concept_tianyi_hu.png"),
    ...
    "FIN-01": ("巨门·账", "concept_jumen_zhang.png"),
    "FIN-05": ("文曲·算", "concept_wenqu_suan.png"),
    "FIN-09": ("陀罗·扛", "concept_tuoluo_kang.png"),
    "FIN-10": ("天乙·催", "concept_tianyi_cui.png"),
    "FIN-11": ("天空·削", "concept_tiankong_xiao.png"),
    "LIV-07": ("太乙·缮", "concept_taiyi_shan.png"),
    "LIV-08": ("地劫·迁", "concept_dijie_qian.png"),
    "LIV-10": ("天乙·告", "concept_tianyi_gao.png"),
    "ADM-07": ("太乙·整", "concept_taiyi_zheng.png"),
    "ADM-08": ("地劫·消", "concept_dijie_xiao.png"),
    "ADM-09": ("陀罗·耗", "concept_tuoluo_hou.png"),
    "ADM-10": ("天乙·询", "concept_tianyi_xun_adm.png"),
    "ADM-11": ("天空·弃", "concept_tiankong_qi.png"),
    "CRE-04": ("文昌·等", "concept_wenchang_deng.png"),
    "CRE-05": ("文曲·摹", "concept_wenqu_mo.png"),
    "CRE-06": ("七杀·逆", "concept_qisha_ni.png"),
    "CRE-07": ("太乙·追", "concept_taiyi_zhui.png"),
    "CRE-08": ("地劫·封", "concept_dijie_feng.png"),
    "CRE-09": ("陀罗·虔", "concept_tuoluo_qian.png"),
    "CRE-10": ("天乙·祈", "concept_tianyi_qi.png"),
    "CAR-11": ("破军·惑", "concept_pojun_huo.png"),
    "RIG-01": ("巨门·诉", "concept_jumen_su.png"),
    "RIG-02": ("天机·裁", "concept_tianji_cai.png"),
    "RIG-03": ("武曲·行", "concept_wuqu_xing.png"),
    "RIG-04": ("文昌·待", "concept_wenchang_dai.png"),
    "RIG-05": ("文曲·纠", "concept_wenqu_jiu.png"),
    "RIG-07": ("太乙·执", "concept_taiyi_zhi.png"),
    "RIG-10": ("天乙·救", "concept_tianyi_jiu.png"),
}
